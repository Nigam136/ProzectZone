...
import { AddBadge, addproject } from "../../axios/instance";
...
const AddNewProject = () => {
  ...
  const [{ ProjectDetails, user, dashboard, isAuthenticated }, dispatch] =
    useDataLayerValues();
  // console.log("qqqqqqqqq", ProjectDetails);
  ...
  const addNewProject = async (title, level, skillInputs, github) => {
    ...
    try {
      ...
      switch (dashboard.projects_added.length + 1) {
        case 3:
          badgedata = {
            title: "Bronze in adding",
            badge_description: "Added 10+ projects",
          };
          break;
        case 6:
          badgedata = {
            title: "Silver in adding",
            badge_description: "Added 50+ projects",
          };
          break;
        case 10:
          badgedata = {
            title: "Gold in adding",
            badge_description: "Added 100+ projects",
          };
          break;
      }
